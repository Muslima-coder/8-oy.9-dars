...
const ProductItem:FC<{item:ProductType}> = ({item}) => {
  return (
    <div className="w-[350px] h-[500px] text-white bg-transparent shadow-xl shadow-slate-200 p-2 rounded-lg overflow-hidden ">
            <Image className="mb-2" src={item.images[0]} alt="Product img" width="350" height="200" />
